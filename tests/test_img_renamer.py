...
from img_renamer import rename_file
...
class TestImageRenamer(unittest.TestCase):
    ...
    def test_rename_file(self, name, input_filename, existing_files, expected):
        result = rename_file(input_filename, existing_files)
